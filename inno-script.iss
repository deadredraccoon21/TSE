...
; We rename it to mssql.yaml inside the 'datasources' folder. Grafana reads anything in this folder.
...
; We use PowerShell to add the rules as requested.
...
Filename: "{app}\nssm.exe"; Parameters: "set Tse-Scada AppStdout NUL"; Flags: runhidden
Filename: "{app}\nssm.exe"; Parameters: "set Tse-Scada AppStderr NUL"; Flags: runhidden
...
Filename: "{app}\nssm.exe"; Parameters: "stop Tse-Scada"; Flags: runhidden
Filename: "{app}\nssm.exe"; Parameters: "remove Tse-Scada confirm"; Flags: runhidden
; 2. (Optional) Remove Firewall Rules
